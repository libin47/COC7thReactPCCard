...
export const work_default: { [key: string]: any } = {
    ...
    "中介调查员": { 'name': '中介调查员', '信用评级': [20, 45], 'describe': '四选一(取悦,话术,恐吓,说服)、格斗(斗殴)、射击(任一)、法律、图书馆使用、心理学、潜行、追踪', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '格斗(斗殴)' }, { 'name': '射击' }, { 'name': '法律' }, { 'name': '图书馆使用' }, { 'name': '心理学' }, { 'name': '潜行' }, { 'name': '追踪' }, { 'name': '信用评级' }] },
    ...
    "旅行家": { 'name': '旅行家',"workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }],  '信用评级': [5, 20], 'describe': '射击(任一)、急救、聆听、博物学、导航、侦查、生存(任一)、追踪', 'skill': [{ 'name': '射击' }, { 'name': '急救' }, { 'name': '聆听' }, { 'name': '博物学' }, { 'name': '导航' }, { 'name': '侦查' }, { 'name': '生存' }, { 'name': '追踪' }, { 'name': '信用评级' }] },
    "探险家(古典)": { 'name': '探险家(古典)', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量","外貌"] }], '信用评级': [55, 80], 'describe': '二选一(攀爬,游泳)、射击(任一)、历史、跳跃、博物学、导航、外语(任一)、生存(任一)', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '攀爬' }, { 'name': '游泳' }] }, { 'name': '射击' }, { 'name': '历史' }, { 'name': '跳跃' }, { 'name': '博物学' }, { 'name': '导航' }, { 'name': '外语' }, { 'name': '生存' }, { 'name': '信用评级' }] },
    ...
    "除魅师(现代)": { 'name': '除魅师(现代)', "workPoints": [{ "scale": 4, "att": ["教育"] }], '信用评级': [20, 50], 'describe': '四选二(取悦,话术,恐吓,说服)、二选一(格斗:斗殴,射击:任一)、汽车驾驶、历史、神秘学、心理学、潜行', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗', 'sub_name': '斗殴' }, { 'name': '射击' }] }, { 'name': '汽车驾驶' }, { 'name': '历史' }, { 'name': '神秘学' }, { 'name': '心理学' }, { 'name': '潜行' }, { 'name': '信用评级' }] },
    ...
    "部落成员": { 'name': '部落成员', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [0, 15], 'describe': '二选一(格斗:任一,投掷)、攀爬、聆听、博物学、神秘学、侦查、游泳、生存(任一)', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗' }, { 'name': '投掷' }] }, { 'name': '攀爬' }, { 'name': '聆听' }, { 'name': '博物学' }, { 'name': '神秘学' }, { 'name': '侦查' }, { 'name': '游泳' }, { 'name': '生存' }, { 'name': '信用评级' }] },
    "私家侦探": { 'name': '私家侦探', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '四选一(取悦,话术,恐吓,说服)、四选一(格斗:任一,射击:任一,锁匠,计算机使用Ω)、技艺(摄影)、乔装、法律、图书馆使用、心理学、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗' }, { 'name': '射击' }, { 'name': '锁匠' }, { 'name': '计算机使用Ω' }] }, { 'name': '技艺', 'sub_name': '摄影' }, { 'name': '乔装' }, { 'name': '法律' }, { 'name': '图书馆使用' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    ...
    "黑帮老大": { 'name': '黑帮老大',"workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["外貌"] }],  '信用评级': [60, 95], 'describe': '四选二(取悦,话术,恐吓,说服)、格斗(任一)、射击(任一)、法律、聆听、心理学、侦查', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '法律' }, { 'name': '聆听' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    "黑帮马仔": { 'name': '黑帮马仔', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 20], 'describe': '四选二(取悦,话术,恐吓,说服)、汽车驾驶、格斗(任一)、射击(任一)、心理学、其他个人或时代特长(任二)', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '汽车驾驶' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '心理学' }, { 'number': 2, 'area': 'all' }, { 'name': '信用评级' }] },
    ...
    "赏金猎人": { 'name': '赏金猎人', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '二选一(电气维修,电子学Ω)、二选一(格斗:任一,射击:任一)、四选一(取悦,话术,恐吓,说服)、汽车驾驶、法律、心理学、追踪、潜行', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '电气维修' }, { 'name': '电子学Ω' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗' }, { 'name': '射击' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '汽车驾驶' }, { 'name': '法律' }, { 'name': '心理学' }, { 'name': '追踪' }, { 'name': '潜行' }, { 'name': '信用评级' }] },
    ...
    "刺客": { 'name': '刺客', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [30, 60], 'describe': '乔装、电气维修、格斗(任一)、射击(任一)、锁匠、机械维修、潜行、心理学', 'skill': [{ 'name': '乔装' }, { 'name': '电气维修' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '锁匠' }, { 'name': '机械维修' }, { 'name': '潜行' }, { 'name': '心理学' }, { 'name': '信用评级' }] },
    "银行劫匪": { 'name': '银行劫匪', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [5, 75], 'describe': '二选一(电气维修,机械维修)、汽车驾驶、格斗(任一)、射击(任一)、恐吓、锁匠、操作重型机械、其他个人或时代特长(任一)', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '电气维修' }, { 'name': '机械维修' }] }, { 'name': '汽车驾驶' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '恐吓' }, { 'name': '锁匠' }, { 'name': '操作重型机械' }, { 'number': 1, 'area': 'all' }, { 'name': '信用评级' }] },
    "打手、暴徒": { 'name': '打手、暴徒', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["力量"] }], '信用评级': [5, 30], 'describe': '四选二(取悦,话术,恐吓,说服)、汽车驾驶、格斗(任一)、射击(任一)、心理学、潜行、侦查', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '汽车驾驶' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '心理学' }, { 'name': '潜行' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    ...
    "独行罪犯": { 'name': '独行罪犯', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "外貌"] }], '信用评级': [5, 65], 'describe': '二选一(技艺:表演,乔装)、二选一(格斗:任一,射击:任一)、二选一(锁匠,机械维修)、四选一(取悦,话术,恐吓,说服)、估价、潜行、心理学、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '技艺', 'sub_name': '表演' }, { 'name': '乔装' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗' }, { 'name': '射击' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '锁匠' }, { 'name': '机械维修' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '估价' }, { 'name': '潜行' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    "女飞贼(古典)": { 'name': '女飞贼(古典)', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["外貌"] }], '信用评级': [10, 80], 'describe': '四选二(取悦,话术,恐吓,说服)、二选一(格斗:斗殴,射击:任一)、技艺(任一)、汽车驾驶、聆听、潜行、其他个人或时代特长(任一)', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '格斗', 'sub_name': '斗殴' }, { 'name': '射击' }] }, { 'name': '技艺' }, { 'name': '汽车驾驶' }, { 'name': '聆听' }, { 'name': '潜行' }, { 'number': 1, 'area': 'all' }, { 'name': '信用评级' }] },
    ...
    "走私者": { 'name': '走私者', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "外貌"] }], '信用评级': [20, 60], 'describe': '三选一(汽车驾驶,驾驶:飞行器,驾驶:船)、四选一(取悦,话术,恐吓,说服)、射击(任一)、聆听、导航、心理学、妙手、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '汽车驾驶' }, { 'name': '驾驶', 'sub_name': '飞行器' }, { 'name': '驾驶', 'sub_name': '船' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '射击' }, { 'name': '聆听' }, { 'name': '导航' }, { 'name': '心理学' }, { 'name': '妙手' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    "混混": { 'name': '混混', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [3, 10], 'describe': '四选一(取悦,话术,恐吓,说服)、攀爬、格斗(任一)、射击(任一)、跳跃、妙手、潜行、投掷', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '攀爬' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '跳跃' }, { 'name': '妙手' }, { 'name': '潜行' }, { 'name': '投掷' }, { 'name': '信用评级' }] },
    "军官": { 'name': '军官', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [20, 70], 'describe': '四选二(取悦,话术,恐吓,说服)、会计、射击(任一)、导航、急救、心理学、其他个人或时代特长(任一)', 'skill': [{ 'number': 2, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '会计' }, { 'name': '射击' }, { 'name': '导航' }, { 'name': '急救' }, { 'name': '心理学' }, { 'number': 1, 'area': 'all' }, { 'name': '信用评级' }] },
    "海军": { 'name': '海军', "workPoints": [{ "scale": 4, "att": ["教育"] }], '信用评级': [9, 30], 'describe': '二选一(电气维修,机械维修)、格斗(任一)、射击(任一)、急救、导航、驾驶(船)、生存(海上)、游泳', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '电气维修' }, { 'name': '机械维修' }] }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '急救' }, { 'name': '导航' }, { 'name': '驾驶', 'sub_name': '船' }, { 'name': '生存', 'sub_name': '海上' }, { 'name': '游泳' }, { 'name': '信用评级' }] },
    "间谍": { 'name': '间谍', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "外貌"] }], '信用评级': [20, 60], 'describe': '二选一(技艺:表演,乔装)、四选一(取悦,话术,恐吓,说服)、射击(任一)、聆听、外语(任一)、心理学、妙手、潜行', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '技艺', 'sub_name': '表演' }, { 'name': '乔装' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '射击' }, { 'name': '聆听' }, { 'name': '外语' }, { 'name': '心理学' }, { 'name': '妙手' }, { 'name': '潜行' }, { 'name': '信用评级' }] },
    "士兵": { 'name': '士兵', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '二选一(攀爬,游泳)、二选一(机械维修,外语:任一)、闪避、格斗(任一)、射击(任一)、潜行、生存(任一)、急救', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '攀爬' }, { 'name': '游泳' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '机械维修' }, { 'name': '外语' }] }, { 'name': '闪避' }, { 'name': '格斗' }, { 'name': '射击' }, { 'name': '潜行' }, { 'name': '生存' }, { 'name': '急救' }, { 'name': '信用评级' }] },
    "警探(原作向)": { 'name': '警探(原作向)', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [20, 50], 'describe': '二选一(技艺:表演,乔装)、四选一(取悦,话术,恐吓,说服)、射击(任一)、法律、聆听、心理学、侦查、其他个人或时代特长(任一)', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '技艺', 'sub_name': '表演' }, { 'name': '乔装' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '射击' }, { 'name': '法律' }, { 'name': '聆听' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'number': 1, 'area': 'all' }, { 'name': '信用评级' }] },
    "巡警(原作向)": { 'name': '巡警(原作向)', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '二选一(汽车驾驶,骑术)、四选一(取悦,话术,恐吓,说服)、格斗(斗殴)、射击(任一)、急救、法律、心理学、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '汽车驾驶' }, { 'name': '骑术' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '格斗(斗殴)' }, { 'name': '射击' }, { 'name': '急救' }, { 'name': '法律' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    ...
    "司法人员": { 'name': '司法人员', "workPoints": [{ "scale": 4, "att": ["教育"] }], '信用评级': [20, 40], 'describe': '汽车驾驶、格斗(斗殴)、射击(任一)、法律、说服、潜行、侦查、其他个人或时代特长(任一)', 'skill': [{ 'name': '汽车驾驶' }, { 'name': '格斗(斗殴)' }, { 'name': '射击' }, { 'name': '法律' }, { 'name': '说服' }, { 'name': '潜行' }, { 'name': '侦查' }, { 'number': 1, 'area': 'all' }, { 'name': '信用评级' }] },

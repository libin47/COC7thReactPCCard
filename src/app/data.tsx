...
export const work_default: { [key: string]: {name?:string, 信用评级:number[], workPoints:{ scale: number, att: ATT_Type[] }[], describe:string, skill: ({number:number, area:string, list?:any} | {name:string, sub_name?:string} )[],  } } = {
    ...
    "部落成员": { 'name': '部落成员', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [0, 15], 'describe': '二选一(格斗:任一,投掷)、攀爬、聆听、博物学、神秘学、侦查、游泳、生存(任一)', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ "number": 1, "area": "list", "list": [{ "name": "格斗:斗殴" },{ "name": "格斗" }] }, { 'name': '投掷' }] }, { 'name': '攀爬' }, { 'name': '聆听' }, { 'name': '博物学' }, { 'name': '神秘学' }, { 'name': '侦查' }, { 'name': '游泳' }, { 'name': '生存' }, { 'name': '信用评级' }] },
    "私家侦探": { 'name': '私家侦探', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '四选一(取悦,话术,恐吓,说服)、四选一(格斗:任一,射击:任一,锁匠,计算机使用Ω)、技艺(摄影)、乔装、法律、图书馆使用、心理学、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'number': 1, 'area': 'list', 'list': [{ "number": 1, "area": "list", "list": [{ "name": "格斗:斗殴" },{ "name": "格斗" }] }, { "number": 1, "area": "list", "list": [{ "name": "射击:手枪" },{ "name": "射击:步/霰" },{ "name": "射击" }] }, { 'name': '锁匠' }, { 'name': '计算机使用Ω' }] }, { 'name': '技艺', 'sub_name': '摄影' }, { 'name': '乔装' }, { 'name': '法律' }, { 'name': '图书馆使用' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
    ...
    "赏金猎人": { 'name': '赏金猎人', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "力量"] }], '信用评级': [9, 30], 'describe': '二选一(电气维修,电子学Ω)、二选一(格斗:任一,射击:任一)、四选一(取悦,话术,恐吓,说服)、汽车驾驶、法律、心理学、追踪、潜行', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '电气维修' }, { 'name': '电子学Ω' }] }, { 'number': 1, 'area': 'list', 'list': [{ "number": 1, "area": "list", "list": [{ "name": "格斗:斗殴" },{ "name": "格斗" }] }, { "number": 1, "area": "list", "list": [{ "name": "射击:手枪" },{ "name": "射击:步/霰" },{ "name": "射击" }] },] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '汽车驾驶' }, { 'name': '法律' }, { 'name': '心理学' }, { 'name': '追踪' }, { 'name': '潜行' }, { 'name': '信用评级' }] },
    ...
    "独行罪犯": { 'name': '独行罪犯', "workPoints": [{ "scale": 2, "att": ["教育"] }, { "scale": 2, "att": ["敏捷", "外貌"] }], '信用评级': [5, 65], 'describe': '二选一(技艺:表演,乔装)、二选一(格斗:任一,射击:任一)、二选一(锁匠,机械维修)、四选一(取悦,话术,恐吓,说服)、估价、潜行、心理学、侦查', 'skill': [{ 'number': 1, 'area': 'list', 'list': [{ 'name': '技艺', 'sub_name': '表演' }, { 'name': '乔装' }] }, { 'number': 1, 'area': 'list', 'list': [{ "number": 1, "area": "list", "list": [{ "name": "格斗:斗殴" },{ "name": "格斗" }] }, { "number": 1, "area": "list", "list": [{ "name": "射击:手枪" },{ "name": "射击:步/霰" },{ "name": "射击" }] },] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '锁匠' }, { 'name': '机械维修' }] }, { 'number': 1, 'area': 'list', 'list': [{ 'name': '取悦' }, { 'name': '话术' }, { 'name': '恐吓' }, { 'name': '说服' }] }, { 'name': '估价' }, { 'name': '潜行' }, { 'name': '心理学' }, { 'name': '侦查' }, { 'name': '信用评级' }] },
